...
##################################
set.seed(88888888)
(FA_PA_V_ParallelAnalysis <- fa.parallel(DPA.Descriptors.Numeric,
                                        fm="pa",
                                        fa="fa",
                                        n.iter=500,
                                        plot=FALSE))
...
# for each factor
##################################
alpha(DPA.Descriptors.Numeric[,c("CHA","COM","ENT","PAS","MAS")])
alpha(DPA.Descriptors.Numeric[,c("FRI","EXP")])
alpha(DPA.Descriptors.Numeric[,c("MOT","CAR")])
