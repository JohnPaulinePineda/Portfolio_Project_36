...
##  1.1 Sample Data
|
| The [<mark style="background-color: #EEEEEE;color: #FF0000">**TeacherEvaluation**</mark>](https://real-statistics.com/multivariate-statistics/factor-analysis/factor-analysis-example/) datasets obtained from the  [<mark style="background-color: #CCECFF">**Real Statistics Using Excel**</mark>](https://real-statistics.com/) website by [**Charles Zaiontz**](https://real-statistics.com/contact-us/) was used for this illustrated example.   
|
...
# ##################################
# (DPA_CorrelationMatrixDeterminant <- det(cor(TeacherEvaluation.FA)))
...
# ##################################
# (DPA_BartlettTest <- cortest.bartlett(TeacherEvaluation.FA,
#                                       n=nrow(TeacherEvaluation.FA)))
...
# ##################################
# (DPA_KMOFactorAdequacy <- KMO(TeacherEvaluation.FA))
# (DPA_KMOFactorAdequacy <- KMO(TeacherEvaluation.FA[,!names(TeacherEvaluation.FA) %in% c("ONOM")]))
# (DPA_KMOFactorAdequacy <- KMO(TeacherEvaluation.FA[,!names(TeacherEvaluation.FA) %in% c("OWIN")]))
# (DPA_KMOFactorAdequacy <- KMO(TeacherEvaluation.FA[,!names(TeacherEvaluation.FA) %in% c("ONOM","OWIN")]))
...
# # Loading dataset
# ##################################
# EDA_TeacherEvaluation <- TeacherEvaluation
# str(EDA_TeacherEvaluation)
# 
# ##################################
...
# ##################################
# set.seed(88888888)
# (FA_PA_V_ParallelAnalysis <- fa.parallel(TeacherEvaluation.FA,
#                                         fm="pa",
#                                         fa="fa",
#                                         n.iter=500,
#                                         plot=FALSE))
...
# # of the same size as the original
# ##################################
# (FA_PA_V_MinimumAveragePartialAnalysis <- VSS(TeacherEvaluation.FA,
#                                               plot=FALSE))
# 
# ##################################
...
# ##################################
# FA_PA_V <- fa(TeacherEvaluation.FA,
#               nfactors = 2,
#               fm="pa",
#               rotate = "varimax",
#               residuals=TRUE,
#               SMC=TRUE,
#               n.obs=nrow(TeacherEvaluation.FA))
# 
# print(FA_PA_V,
#       digits=3,
#       sort=TRUE)
...
# # for each factor
# ##################################
# alpha(TeacherEvaluation.FA[,c("ICTC","TCTC","ONOM")])
# alpha(TeacherEvaluation.FA[,c("IAUD","TAUD","OWIN")])
# 
# ##################################
...
# ##################################
# FA_PA_V_FactorLoading <- factload(TeacherEvaluation.FA,
#                                   cormeth = "pearson",
#                                   method = "prax",
#                                   nfac = 2,
#                                   rotation = "varimax")
...
# FA_ML_V_FactorLoading <- factload(TeacherEvaluation.FA, 
#                                   cormeth = "pearson",
#                                   method = "mle", 
#                                   nfac = 2, 
#                                   rotation = "varimax")
