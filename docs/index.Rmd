...
##################################
set.seed(88888888)
(FA_PA_P_ParallelAnalysis <- fa.parallel(DPA.Descriptors.Numeric,
                                        fm="pa",
                                        fa="fa",
                                        n.iter=500,
                                        plot=FALSE))
...
##################################
set.seed(88888888)
(FA_ML_V_ParallelAnalysis <- fa.parallel(DPA.Descriptors.Numeric,
                                        fm="ml",
                                        fa="fa",
                                        n.iter=500,
                                        plot=FALSE))
...
##################################
set.seed(88888888)
(FA_ML_P_ParallelAnalysis <- fa.parallel(DPA.Descriptors.Numeric,
                                        fm="ml",
                                        fa="fa",
                                        n.iter=500,
                                        plot=FALSE))
