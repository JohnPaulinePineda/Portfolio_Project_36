...
set.seed(88888888)
(FA_MR_V_ParallelAnalysis <- fa.parallel(Oscars.FA,
                                        fm="minres",
                                        fa="fa",
                                        n.iter=500,
                                        plot=FALSE))
...
(FA_MR_V_MinimumAveragePartialAnalysis <-VSS(Oscars.FA, 
                                            fm="minres",
                                            rotate = "varimax",
                                            n.obs=nrow(Oscars.FA),
                                            plot=FALSE))

FA_MR_V <- fa(Oscars.FA, 
              nfactors = 2, 
              fm="minres",
              rotate = "varimax",
              residuals=TRUE,
...
(FA_MR_V_Residual <- residuals(FA_MR_V,
                              diag=FALSE,
                              na.rm=TRUE))
